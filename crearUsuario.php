...
<div class="contact" id="contact">
  <div class="container">
    ...
    <div class="col-md-offset-1 col-md-10">
      <h2>Creación de usuario<i class="fa fa-user"></i></h2>
    ...
    <form method="post" action="creaUsuario.php" name="contactform" id="contactform" enctype="multipart/form-data">
      ...
      <div class="col-md-7">
        ...
        <input name="provincia" type="text" id="provincia" size="30" placeholder="Provincia" >
          ...
          <br>
          <input name="perfil" type="text" id="perfil" size="30" placeholder="Tipo de usuario">
          <br>
          
          <input name="bloqueado" type="number" id="bloqueado" size="30" min="0" max="1" placeholder="Usuario bloqueado">
          <br>
